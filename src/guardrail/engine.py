...
class StarterGuardrail:
    def __init__(self, detectors=None, policy=None):
        self._custom_detectors = tuple(detectors) if detectors is not None else None
    ...
    def check(self, request):
        ...
        route_str = str(request.context.route.value) if hasattr(request.context.route, 'value') else str(
